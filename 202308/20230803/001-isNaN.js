// isNaN() 함수는 어떤 값이 NaN인지 판별합니다. 어떤값이 숫자가 아닌지 판별한다.
// 숫자로 판별되면 false, 숫자가 아닌 것들은 true
...
//문제는 다 더하는것으로 고치겠습니다. 정렬 안배웠기 때문에
let value2 = "p2o4"
let sum = 0
if(!isNaN(value[0])) {
...
//문자 거르고, 숫자만 더해져서 결과 6

//split, filter
let value3 = "p2o4"
"p2o4".split("").filter(v => !isNaN(v))
//[2,4]
